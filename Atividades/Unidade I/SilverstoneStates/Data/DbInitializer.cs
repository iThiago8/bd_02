...
namespace SilverstoneStates.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new() { Id = 1, Name = "Casa de Campo", Description = "Uma bela casa com 3 quartos e vista para as montanhas.", NumberOfRooms = 3, Market_Value = 75000 },
            ...
            foreach (Realty s in realties)
            {
                context.Realties.Add(s);
            }
            context.SaveChanges();
        }
    }
